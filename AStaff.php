              ...
              <div class="row jumbotron">
                  ...
                  <div class="col-md-6 form-group">
                      <label for="inputname">Category</label>
                        <select class="form-control" name="p_bgroup"><option value=" " disabled selected hidden>--Select--</option></select>
                        </div>
                  ...
                  <button type="submit" class="button button1 col-md-4">Add Staff</button>
