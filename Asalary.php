  ...
  <div class="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
            <a href="Asalary.php" class="active">
    ...
    <nav>
      <div class="sidebar-button">
        <i class='bx bx-menu sidebarBtn'></i>
            <span class="dashboard">Salary</span>
          </a>
      </div>
          ...
          <form name="myform">
              ...
              <div class="row jumbotron">
                  <div class="col-md-6 form-group">
                      <label for="inputname">Emploee Name</label>
                      <input type="text" class="form-control" placeholder="Enter Emploee Name">
                  </div>
                  ...
                  <div class="col-md-6 form-group">
                      <label for="inputname">GPF/EPF/PRAN A/c No.</label>
                      <input type="text" class="form-control" placeholder="Enter GPF/EPF/PRAN A/c No.">
                  </div>
                  ...
                  <div class="col-md-6 form-group">
                      <label for="mobile">Bank Account</label>
                      <input type="number" class="form-control" placeholder="Enter Bank Account">
                  </div>
                  
                  <div class="col-md-6 form-group">
                      <label for="inputname">Vouchar No.</label>
                      <input type="text" class="form-control" placeholder="Enter Vouchar No.">
                  </div>
                  
                  <div class="col-md-6 form-group">
                      <label for="mobile">Working Days</label>
                      <input type="number" class="form-control" placeholder="Enter Working Days">
                  </div>  
                  
                  <div class="col-md-6 form-group">
                      <label for="inputname">Basic Pay</label>
                      <input type="text" class="form-control" placeholder="Enter Basic Pay">
                  </div> 
                  
                  <div class="col-md-6 form-group">
                      <label for="inputname">Income Tax</label>
                      <input type="text" class="form-control" placeholder="Enter Income Tax">
                  </div>
                  
                  <div class="col-md-6 form-group">
                      <label for="inputname">D.A.</label>
                      <input type="text" class="form-control" placeholder="Enter D.A.">
                  </div> 
                  <div class="col-md-6 form-group">
                      <label for="inputname">Profess.</label>
                      <input type="text" class="form-control" placeholder="Enter Profess.">
                  </div> 
                  ...
                  <button type="submit" class="button button1 col-md-4">Pay Salary</button>
