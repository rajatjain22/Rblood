    ...
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
            ...
            <span class="links_name">Information / Donor</span>
          </a>
        </li>
        <li>
            <a href="../AReport.php">
    ...
    <nav>
      <div class="sidebar-button">
        <i class='bx bx-menu sidebarBtn'></i>
            <span class="dashboard">Information / Donor</span>
          </a>
      </div>
            ...
            <table class="table table-striped table-hover" id="myTable">
					...
					<tbody >
                                            <?php
                                                $con= mysqli_connect('localhost:3308', 'root','');
                                                mysqli_select_db($con,'rblood');
                                                $q1="select * from donor ORDER BY d_id asc";
                                            ...
                                            <tr >
                                                <td>
                                                    <input type="checkbox" name="checkbox" value="<?php $row['d_email']; ?>">
                                                </td>
                                                ...
                                                <td><?php echo $row['d_bgroup']; ?></td>

                                               <td> <img src="<?php echo $row['d_photo']; ?>"  height="100px" width="100px" alt=""/></td>     
                                                <td>
                                                    <button class="btn btn-info edit"><a href="../update/update_Donor.php?updateid=<?php echo $row['d_id']; ?>" style="text-decoration: none;color:white; "><i class="material-icons">&#xE254;<span>Edit</span></i></a></button>
                                                    <button class="btn btn-danger delete"><a href="../delete/delete_Donor.php?deleteid=<?php echo $row['d_id']; ?>" style="text-decoration: none;color:white;"><i class="material-icons">&#xE872;<span>Delete</span> </i></a></button>
                                                </td>
