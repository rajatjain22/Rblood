    ...
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
            ...
            <span class="links_name">Information / Admin</span>
          </a>
        </li>
        <li>
            <a href="../AReport.php">
    ...
    <nav>
      <div class="sidebar-button">
        <i class='bx bx-menu sidebarBtn'></i>
            <span class="dashboard">Information / Admin</span>
          </a>
      </div>
		...
		<div class="table-responsive">		
            ...
            <table class="table table-striped table-hover" id="myTable">
					...
					<tbody >
                                            ...
                                            <tr >
                                                <td>
                                                    <input type="checkbox" name="checkbox" value="<?php $row['a_email']; ?>">
                                                </td>
                                                ...
                                                <td><?php echo $row['a_bgroup']; ?></td>

                                               <td> <img src="<?php echo $row['a_photo']; ?>"  height="100px" width="100px" alt=""/></td>     
                                                <td>
                                                    <button class="btn btn-info edit"><a href="../update/update_admin.php?updateid=<?php echo $row['a_id']; ?>" style="text-decoration: none;color:white; "><i class="material-icons">&#xE254;<span>Edit</span></i></a></button>
                                                    <button class="btn btn-danger delete"><a href="../delete/delete_admin.php?deleteid=<?php echo $row['a_id']; ?>" style="text-decoration: none;color:white;"><i class="material-icons">&#xE872;<span>Delete</span> </i></a></button>
                                                </td>
