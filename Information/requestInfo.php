    ...
    <div class="logo-details">
      ...
      <ul class="nav-links">
        ...
        <li>
            ...
            <span class="links_name">Information / Request</span>
          </a>
        </li>
        <li>
            <a href="../AReport.php">
 ...
 <section class="home-section">
    <nav>
      <div class="sidebar-button">
        <i class='bx bx-menu sidebarBtn'></i>
            <span class="dashboard">Information / Request</span>
          </a>
      </div>
    ...
    <div class="container">
		<div class="table-responsive">		
                    <h2><b>Blood Request </b>Information</h2>
            ...
            <table class="table table-striped table-hover" id="myTable">
					...
					<tbody >
                                            <?php
                                                ...
                                                $q1="select * from request_blood ORDER BY r_id asc";
                                            ...
                                            <tr >
                                                <td>
                                                    <input type="checkbox" name="checkbox" value="<?php $row['r_id']; ?>">
                                                </td>
                                                ...
                                                <td>
                                                    <button class="btn btn-info edit"><a href="../update/update_request.php?updateid=<?php echo $row['r_id']; ?>" style="text-decoration: none;color:white; "><i class="material-icons">&#xE254;<span>Edit</span></i></a></button>
                                                    <button class="btn btn-danger delete"><a href="../delete/delete_request.php?deleteid=<?php echo $row['r_id']; ?>" style="text-decoration: none;color:white;"><i class="material-icons">&#xE872;<span>Delete</span> </i></a></button>
                                                </td>
